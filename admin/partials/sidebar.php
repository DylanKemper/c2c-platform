...
<div class="admin-sidebar d-flex flex-column flex-shrink-0 p-3" style="width: 260px; min-height: 100vh;">
    ...
    <!-- Brand -->
    <a href="index.php" class="sidebar-brand d-flex align-items-center mb-4 text-decoration-none">
    ...
    <div class="mt-auto">
        ...
        <div class="dropdown">
            <a href="#"
                class="sidebar-user d-flex align-items-center text-decoration-none dropdown-toggle"
                id="adminUserDropdown"
                data-bs-toggle="dropdown"
                aria-expanded="false">
                <div class="sidebar-avatar me-2">A</div>
                <div class="lh-1">
                    <p class="mb-0 sidebar-user-name">Admin</p>
                    <p class="mb-0 sidebar-user-role">Super Admin</p>
                </div>
            </a>

            <ul class="dropdown-menu dropdown-menu-dark sidebar-dropdown shadow"
